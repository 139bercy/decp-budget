...
Les données essentielles de la commande publique (DECP), enrichies par le BercyHub, sont mises en *open source* sur la plateforme du ministère, accessible à l'adresse : <https://data.economie.gouv.fr/explore/dataset/decp_augmente/table>[^15]. Par la collaboration avec la direction du Budget (2PERF), ces données ont été filtrées en conservant uniquement les marchés publiés par l'AIFE et correspondant aux acheteurs relevant du périmètre de l'État[^4]. Dans un souci de qualité des données, les marchés publiés avant 2018 ont été exclus. Les données à l'étude sont, à la date de l'étude, un tableau contenant 24 041 lignes et 28 colonnes. 

[^15]: Un monitoring de ces données est accessible en ligne : <https://139bercy.github.io/decp-monitoring/#dashboard>. Celles-ci font actuellement l'objet d'un audit de qualité, dont les premiers résultats sont disponibles à l'adresse : <https://share.streamlit.io/139bercy/decp-qualite/main>.
